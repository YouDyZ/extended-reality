...
export class Camera {
    constructor(pos, fov) {
        ...
        this.cam = native.createCamWithParams('DEFAULT_SCRIPTED_CAMERA', pos.x, pos.y, pos.z, 0, 0, 0, fov, true, 0);
    ...
    pointAtBone(entity, bone, xOffset, yOffset, zOffset) {
        native.pointCamAtPedBone(this.cam, entity, bone, xOffset, yOffset, zOffset, false);
        native.setCamActive(this.cam, true);
        native.renderScriptCams(true, false, 0, true, false);
    }
