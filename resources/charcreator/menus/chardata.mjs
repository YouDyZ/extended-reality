...
export const appearanceNames = ["Flecken", "Gesichtsbehaarung", "Augenbrauen", "Alterung", "Makeup", "Errötung", "Teint", "Sonnenschaden", "Lippenstift", "Leberfleck & Sommersprossen", "Brusthaar"];
